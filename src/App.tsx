                    ...
                    <div className="work">
                        <div className="work-company">
                            ...
                            <div className="work-company-role">
                                ...
                                <ul>
                                    <li>Paired with developers from other teams to spread modern software development
                                        practices
                                    </li>
                                    <li>Facilitated courses that introduced new frameworks and software tools to
                                        developers
                                    </li>
                                    <li>Utilized Test-Driven Development and a Kanban board as part of the Extreme
                                        Programming
                                    ...
                                    <li>Deployed a React app that utilized SSO and JWTs to securely authenticate users
                                    </li>
                                    <li>Crafted RESTful apis with Springboot and Kotlin</li>
                                    <li>Co–developed an app to optimize purchasing that discovered $1.5 billion in
                                        unrealized savings
                            ...
                            <ul>
                                <li>Created a website using .NET to host real-time visualizations created by our team
                                </li>
                                <li>Visualized data in Tableau that eliminated hundreds of hours spent on presentations
                                    annually
                                </li>
                                <li>Connected engineering, production, and supply chain data to provide metrics on part
                                    changes all
                                </li>
                                the way from design to installation
                                o Used R to process data on over 4,500 parts from 8 databases to determine if
                                engineering
                                changes will cause parts to arrive late
                                o Selected as one of the top four projects for 2018 in an organization of several
                                thousand
                                <li>Designed a risk management visualization package used by BCA, BDS, and Boeing
                                    IT</li>
                            </ul>
                            ...
                            <ul>
                                ...
                                <li>Eliminated 90 engineer man-hours quarterly implementing report automation using
                                    VBA
                                </li>
